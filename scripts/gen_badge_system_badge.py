"""Generate the Badge System guidebook-tab badge in the section-badge family."""
import sys, os
...
made = make("section", PAL["fuchsia"], "palette", "Badge System", "badge-badge-system.png", autowidth=True)
print(made)
